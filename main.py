...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    print("layer7a_out.shape: ",layer7a_out.shape)
    ...
    print("layer4a_in1.shape: ",layer4a_in1.shape)
    ...
    print("layer4a_in2.shape: ",layer4a_in2.shape)

    layer4a_out = tf.add(layer4a_in1, layer4a_in2)
    
    print("layer4a_out.shape: ",layer4a_out.shape)
